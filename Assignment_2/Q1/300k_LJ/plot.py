...
data = np.loadtxt('rdf_b001_m001_u001_m002_u001', skiprows=1)  # Skip the first line
...
plt.plot(r, g_r, 'b-', label='g(r) 300K Hard Sphere')
plt.xlabel('Distance (Å)')
plt.ylabel('Radial Distribution Function, g(r)')
plt.title('RDF for Binary Hard Sphere System at 300K')
plt.legend()
