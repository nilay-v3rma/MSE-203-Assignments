...
data1 = np.loadtxt('300k_LJ/rdf_b001_m002_u001_m002_u001', skiprows=1)  # 300K
data2 = np.loadtxt('500k_LJ/rdf_b001_m002_u001_m002_u001', skiprows=1)  # 500K
data3 = np.loadtxt('800k_LJ/rdf_b001_m002_u001_m002_u001', skiprows=1)  # 800K
...
plt.title('RDF for Lennard-Jones System at Different Temperatures')
plt.legend()
...
# Adjust annotation to emphasize LJ characteristics
plt.text(3.0, 1.5, 'Lennard-Jones potential leads to temperature-dependent RDF',
         fontsize=10, bbox=dict(facecolor='white', alpha=0.8))

# Add a vertical line at the first peak position
plt.axvline(x=peak_r, color='gray', linestyle='--', alpha=0.3)

plt.savefig("rdf_all_LJ.png")
