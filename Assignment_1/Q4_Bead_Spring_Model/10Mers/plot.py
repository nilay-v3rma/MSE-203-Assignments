...
# Load the CSV file
file_path = "msd_data_10.csv"  # Update with your CSV file path
...
plt.plot(time, msd, linestyle='-', color='b', label=f"Polymer (N=10)")
...
plt.title("MSD vs. Time (Chain Length N=10)", fontsize=16)
plt.legend()
